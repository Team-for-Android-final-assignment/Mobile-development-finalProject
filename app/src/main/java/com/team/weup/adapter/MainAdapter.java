...
public class MainAdapter extends BaseAdapter {
	...
	public MainAdapter(List<Note> list, Context context) {
		super();
		this.list = list;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.tv_note_id.setText( list.get(position).getId().toString() );
		holder.tv_note_title.setText(list.get(position).getTitle());
		holder.tv_note_time.setText(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(list.get(position).getEditTime()));


		String context = list.get(position).getText();
		// 定义正则表达式，用于匹配路径
...
//				}
	...
	class Holder {
		public TextView tv_note_id, tv_note_title, tv_note_time;
